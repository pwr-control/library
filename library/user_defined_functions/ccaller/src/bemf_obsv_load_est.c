...
void bemf_obsv_load_est_init(volatile BEMF_OBSV_LOAD_EST *f, volatile float bemf_obsv_fb_p_1, volatile float bemf_obsv_p_1, 
	...
	volatile float motorc_load_inertia_norm, volatile float bemf_obsv_luenberger_1, volatile float bemf_obsv_luenberger_2, 
	volatile float bemf_obsv_luenberger_3, volatile float phase_compensation_omega, volatile float phase_compensation_torque, 
	volatile float omega_flt_fcut)
{
	f->ts = 0.0;
	...
	bemf_obsv_load_est_reset(f);
}

void bemf_obsv_load_est_update(volatile BEMF_OBSV_LOAD_EST *f, volatile float bemf_obsv_fb_p_1, volatile float bemf_obsv_p_1, 
...
float bemf_obsv_load_est_process(volatile BEMF_OBSV_LOAD_EST *f, volatile float u_alpha, volatile float u_beta, 
	volatile float i_alpha, volatile float i_beta, volatile float u_dc, volatile float motor_torque_pu)
{
	float bemf_obsv_fb_p = 0.0;
	float bemf_obsv_p = 0.0;

	const float omega_lim_top = BEMF_OBS_LOAD_EST_UPDATE_TH + BEMF_OBS_LOAD_EST_UPDATE_HY;
	const float omega_lim_bottom = BEMF_OBS_LOAD_EST_UPDATE_TH - BEMF_OBS_LOAD_EST_UPDATE_HY;
