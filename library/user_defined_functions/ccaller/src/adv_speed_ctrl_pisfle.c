...
void adv_speed_ctrl_pisfle_reset(volatile ADV_SPEED_CTRL_PISFLE *f)
{
	...
	f->torque_l_pu_hat = 0.0;
	f->torque_output_ctrl_pu = 0.0;
	f->torque_output_ctrl_i_pu = 0.0;
}

float adv_speed_ctrl_pisfle_process(volatile ADV_SPEED_CTRL_PISFLE *f, volatile float omega_m_pu_ref, volatile float omega_m_pu)
{
	...
	const float torque_l_hat = f->torque_l_pu_hat;
	...
	// 						k_isf_3 * torque_theta_hat + k_isf_4 * torque_l_hat;
	...
	const float torque_theta_hat_hat = torque_output_ctrl * inpm_b3 + ts*l_sobs_3 * omega_m_hat_tilde + 
							...
							trm_a34 * torque_l_hat;
	
	const float torque_l_hat_hat = torque_output_ctrl * inpm_b4 + ts*l_sobs_4 * omega_m_hat_tilde + 
						trm_a41 * omega_m_hat + trm_a42 * omega_l_hat + trm_a43 * torque_theta_hat +
						trm_a44 * torque_l_hat;
	...
	f->torque_l_pu_hat = torque_l_hat_hat;
