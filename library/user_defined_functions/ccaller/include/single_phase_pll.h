...
/* Pre-calculated coefficients for 50 Hz cut-off frequency and 20 kHz sampling frequency */
...
/* Pre-calculated coefficients for 80 Hz cut-off frequency and 20 kHz sampling frequency */
#define B1_ALPHA		0.001255715617533f
#define B2_ALPHA		-0.001255715617533f
#define B1_BETA			0.0000157839236578590f
#define B2_BETA			0.0000157773133488305f
#define A1				-1.998112927436153f
#define A2				0.998744152176287f


/* Pre-calculated coefficients for 400 Hz cut-off frequency and 20 kHz sampling frequency */
