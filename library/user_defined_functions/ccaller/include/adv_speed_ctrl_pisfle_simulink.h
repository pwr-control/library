#ifndef _ADV_SPEED_CTRL_PISFLE_SIMULINK_
#define _ADV_SPEED_CTRL_PISFLE_SIMULINK_

typedef struct adv_speed_ctrl_pisfle_output_s {
	float			torque_output_ref_pu;		/*  */
	float			omega_m_pu_hat;				/*  */
	float			omega_l_pu_hat;				/*  */
	float			torque_theta_pu_hat;		/*  */
	float			torque_l_pu_hat;		    /*  */
} adv_speed_ctrl_pisfle_output_t;
#define ADV_SPEED_CTRL_PISFLE_OUTPUT adv_speed_ctrl_pisfle_output_t

extern ADV_SPEED_CTRL_PISFLE     adv_speed_ctrl_pisfle;
extern unsigned int       adv_speed_ctrl_pisfle_initialized;
